...
## Categories (clusters, subdomains)

Most of the ontologies in this collection cluster into categories or subdomains of the umbrella domains of defence and security. The structure of this repository reflects this clustering. Sometimes, an ontology fits into more than one cluster (subdomain).  Each ontology appears only once in the repository, however --- in the cluster (subdomain) where the fit is deemed strongest.

## Relaxed domain definitions

The domains of defence and security have been **interpreted broadly**. The connection between some of the subdomain clusters and the umbrella domains of defence and security may appear tenuous. Arguments and/or justifications for the inclusion of such subdomains (clusters) in this collection are provided, in various places, within this repository.
